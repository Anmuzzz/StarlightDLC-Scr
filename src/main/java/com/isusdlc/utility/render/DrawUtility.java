...
import com.isusdlc.framework.shader.impl.BlurProgram;
...
import com.isusdlc.utility.render.batching.impl.IconBatching;
import com.isusdlc.utility.render.batching.impl.RectBatching;
import com.isusdlc.utility.render.batching.impl.RoundedRectBatching;
import com.isusdlc.utility.render.batching.impl.SquircleBatching;
import com.isusdlc.utility.render.obj.CustomSprite;
import com.isusdlc.utility.render.penis.PenisSprite;
...
public final class DrawUtility implements IMinecraft, IWindow {
   ...
   public static void initializeShaders() {
      rectangleProgram = new GlProgram(elegant.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      squircleProgram = new GlProgram(elegant.id("squircle/data"), VertexFormats.POSITION_COLOR);
      squircleTextureProgram = new GlProgram(elegant.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      roundedTextureProgram = new GlProgram(elegant.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      borderProgram = new GlProgram(elegant.id("border/data"), VertexFormats.POSITION_COLOR);
      loadingProgram = new GlProgram(elegant.id("loading/data"), VertexFormats.POSITION_COLOR);
      glassProgram = new GlProgram(elegant.id("liquidglass/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      gradientRectangleProgram = new GlProgram(elegant.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
   ...
   public static void drawSprite(MatrixStack matrices, CustomSprite sprite, float x, float y, float width, float height, ColorRGBA color) {
      drawTexture(
         matrices,
         elegant.id(sprite.getTexture().getTexture()),
         x,
         y,
         width,
         height,
