package com.isusdlc.systems.target;
...
public class TargetManager implements IMinecraft {
   ...
   public void addTarget(String name) {
      if (elegant.getInstance().getFriendManager().listFriends().contains(name)) {
   ...
   public LivingEntity getLivingTarget() {
      return elegant.getInstance().getTargetManager().getCurrentTarget() instanceof LivingEntity target2 ? target2 : null;
   }
