...
@ModuleInfo(
   ...
   desc = "Подсвечивает ловушки на карте"
)
   ...
   private final EventListener<PreHudRenderEvent> onHud = ev -> {
      ...
      for (TrapESP.Trap trap : this.traps) {
         ...
         if (screen != null) {
            ...
            ctx.drawTexture(elegant.id("icons/trap.png"), -titleWidth / 2.0F + 2.0F, fontHeight - iconSize / 2.0F, iconSize, iconSize, Colors.WHITE);
