package com.isusdlc.ui.components;
...
import com.isusdlc.framework.objects.gradient.impl.HorizontalGradient;
...
public class ColorPicker extends CustomComponent implements IScaledResolution, IWindow {
   ...
   protected void renderComponent(UIContext context) {
      ...
      context.drawTexture(elegant.id("icons/colorpicker/pipette.png"), this.x + 7.0F, this.y + 6.0F, 8.0F, 8.0F);
      ...
      context.drawTexture(elegant.id("icons/colorpicker/xmark.png"), this.x + this.width - 15.0F, this.y + 5.0F, 10.0F, 10.0F);
      if (GuiUtility.isHovered((double)(this.x + this.width - 15.0F), (double)(this.y + 5.0F), 10.0, 10.0, context.getMouseX(), context.getMouseY())) {
         CursorUtility.set(CursorType.HAND);
      }

      context.drawRoundedTexture(elegant.id("textures/hue.png"), this.x + this.width - 18.0F, this.y + 20.0F, 12.0F, 70.0F, BorderRadius.all(4.0F));
      ...
      if (this.enableAlpha) {
         ...
         context.drawRoundedTexture(elegant.id("textures/empty.png"), this.x + 6.0F, this.y + 102.0F, 100.0F, 12.0F, BorderRadius.all(5.0F));
         context.drawRoundedRect(
            this.x + 6.0F - 0.5F,
            this.y + 102.0F - 0.5F,
            101.0F,
      ...
      if (COLOR_PRESETS.size() < 10) {
         ...
         context.drawTexture(elegant.id("icons/colorpicker/plus.png"), this.x + 45.0F + xOffset, this.y + this.height - 36.0F + yOffset, 11.0F, 11.0F);
         if (GuiUtility.isHovered(this.x + 45.0F + xOffset, this.y + this.height - 36.0F + yOffset, 11.0, 11.0, context)) {
            CursorUtility.set(CursorType.HAND);
         }
      }
      ...
      if (this.pickAnim.getValue() > 0.0F) {
         ...
         context.drawTexture(elegant.id("icons/colorpicker/click.png"), pickRect.getX() + pickRect.getHeight(), pickRect.getY() + 16.0F, 6.0F, 6.0F);
         context.drawText(
