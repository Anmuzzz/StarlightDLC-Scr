package com.isusdlc.ui.hud.inline;
...
public class InlineElement extends HudElement {
   ...
   protected void renderComponent(UIContext context) {
      ...
      context.drawTexture(elegant.id(this.icon), this.x + 5.0F, this.y + 5.0F, 8.0F, 8.0F, Colors.getTextColor());
      float xOffset = 0.0F;
