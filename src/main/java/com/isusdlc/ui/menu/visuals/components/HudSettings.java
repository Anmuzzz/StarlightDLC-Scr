...
public class HudSettings extends CustomComponent {
   ...
   protected void renderComponent(UIContext context) {
      ...
      if (this.showing) {
         context.drawText(
            ...
            Localizator.translate(this.toggle.getElement().getName()),
            x + 7.0F + 2.0F * alpha,
            y + 8.0F + 2.0F * alpha,
            Colors.getTextColor()
         );
      ...
      this.backgroundColorAnimation
         .update(
            this.toggle.getElement().isShowing()
      ...
      context.drawRoundedRect(
         ...
         this.backgroundColorAnimation.getColor().withAlpha(!this.toggle.getElement().isShowing() ? 255.0F - 100.0F * Interface.glass() : 255.0F)
      );
      context.drawRoundedRect(
