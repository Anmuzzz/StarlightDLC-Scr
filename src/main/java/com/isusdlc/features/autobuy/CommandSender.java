...
public class CommandSender {
   ...
   public static void handleServerSwitch(String command) {
      if (mc.player != null && mc.player.networkHandler != null) {
         mc.player.networkHandler.sendPacket(new ChatMessageC2SPacket(command, Instant.now(), 0L, null, new LastSeenMessageList.Acknowledgment(0, new BitSet())));
