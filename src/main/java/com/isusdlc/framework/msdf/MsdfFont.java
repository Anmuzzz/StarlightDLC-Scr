package com.isusdlc.framework.msdf;
...
public final class MsdfFont {
   ...
   public float getWidthOld(String text, float size) {
      ...
      float width = 0.0F;
      boolean skipNext = false;
      NameProtect nameProtectModule = elegant.getInstance().getModuleManager().getModule(NameProtect.class);
   ...
   public static class Builder {
      ...
      public MsdfFont.Builder data(String dataFileName) {
         this.dataIdentifer = Identifier.of(elegant.MOD_ID, "fonts/msdf/" + dataFileName + ".json");
         return this;
      }

      public MsdfFont.Builder atlas(String atlasFileName) {
         this.atlasIdentifier = Identifier.of(elegant.MOD_ID, "fonts/msdf/" + atlasFileName + ".png");
         return this;
      }
