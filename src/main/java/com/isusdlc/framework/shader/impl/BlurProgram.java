package com.isusdlc.framework.shader.impl;
...
import com.isusdlc.utility.render.CustomRenderTarget;
...
public class BlurProgram implements IMinecraft, IWindow {
   ...
   public void initShaders() {
      kawaseDownProgram = new KawaseBlurProgram(elegant.id("kawase_down/data"));
      kawaseUpProgram = new KawaseBlurProgram(elegant.id("kawase_up/data"));
   }
