...
function tailPhysics.new(model)
   ...
   obj.config = { -- default config
	...
	idleSpeed = vec(0.5, 0.5, 0), -- how fast should tail move when nothing is happening
      idleStrength = vec(0.5, 0.5, 0), -- how much should tail move
      ...
      enableWag = {x}, -- if any variable in this table is true tail will wag
